package com.example.sofascore_zavrsni_projekt.ui.american_football
...
import com.example.sofascore_zavrsni_projekt.databinding.AmericanFootballFragmentBinding
...
class AmericanFootballFragment: Fragment() {
    private var _binding: AmericanFootballFragmentBinding? = null
    ...
    private val fragmentName = "american-football"
    ...
    override fun onCreateView(
        ...
        _binding = AmericanFootballFragmentBinding.inflate(inflater, container, false)
        val root: View = binding.root

        binding.americanFootballRecyclerView.apply {
