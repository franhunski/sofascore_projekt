package com.example.sofascore_zavrsni_projekt.ui.football
...
import com.example.sofascore_zavrsni_projekt.databinding.FootballFragmentBinding
...
class FootballFragment: Fragment() {
    private var _binding: FootballFragmentBinding? = null
    ...
    private val fragmentName = "football"
    ...
    override fun onCreateView(
        ...
        _binding = FootballFragmentBinding.inflate(inflater, container, false)
        val root: View = binding.root

        binding.footballRecyclerView.apply {
